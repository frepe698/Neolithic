...
public class EyecandyObject {
	...
	public EyecandyObject(Vector3 position, Quaternion rotation, float yScale, string poolName)
	{
	...
	public EyecandyObject(Vector3 position, Quaternion rotation, string poolName)
	{
		this.position = position;
		this.rotation = rotation;
		this.poolName = poolName;
	...
	{
		EyecandyObject other = o as EyecandyObject;
