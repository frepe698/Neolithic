...
public class ObjectPool
{
	...
	public GameObject GetObject()
	{
		...
		//Debug.Log ("added " + pooledObj.name + " to pool");
		//No inactive objects. Instantiate a new object.
	...
	public void Shrink()
	{
		...
		/*for (int i = pooledObjects.Count - 1; i >= 0; i--)
		{
			...
			if (!pooledObjects[i].activeSelf)
			{
				...
				objectsRemoved++;
				if(objectsRemoved >= objectsToRemoveCount)
				{
					//Debug.Log ("Removed: " + objectsRemoved + " items");
					return;
				}
			}
		}*/
